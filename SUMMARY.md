...
`pnpm typecheck`, `pnpm lint`, `pnpm test` (96 tests, 26 files), and `pnpm build` all pass. Build prerenders `/`, `/communities`, `/communities/wildfire-watch`, `/f/{alerts,shelter,replant}`, `/u/janahan`.
